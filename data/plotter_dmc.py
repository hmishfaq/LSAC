...
X_FACTOR = 1e6
colour_list = {
    "LSAC": (254 / 255, 6 / 255, 6 / 255),
    "DSAC": (168 / 255, 47 / 255, 47 / 255),
    ...
    "Dreamer": (0 / 255, 0 / 255, 0 / 255),
    "DRQ-V2": (255 / 255, 20 / 255, 147 / 255)
}
environments = [
    "dmc_data/cartpole-balance_sparse.txt",
    "dmc_data/cheetah_run.txt",
    "dmc_data/finger_turn_hard.txt",
    "dmc_data/fish_swim.txt",
    "dmc_data/reacher_hard.txt",
    "dmc_data/walker_walk.txt",
    "dmc_data/walker_run.txt"
]
...
for file in environments:
    ...
    plt.savefig(f"./dmc_data/{env_id}_plot.pdf", bbox_inches="tight")
    plt.show()
