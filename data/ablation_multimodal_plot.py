...
X_FACTOR = 1e6
colour_list = {
    1: (168 / 255, 47 / 255, 47 / 255),
    10: (254 / 255, 6 / 255, 6 / 255),
    20: (254 / 255, 166 / 255, 4 / 255),
    50: (6 / 255, 131 / 255, 7 / 255)
    # "PPO": (8 / 255, 156 / 255, 255 / 255),
    # "SAC": (136 / 255, 15 / 255, 135 / 255),
    # "TRPO": (129 / 255, 129 / 255, 129 / 255)
}
environments = [
    "ablation_multimodal.txt",
]
...
for file in environments:
    ...
    legend_handles = []
    optims = [optim for optim in df['num_critics'].unique()]
    y_max, y_min = list(), list()
    for optim in optims:
        # Filter data for the current algorithm
        algo_data = df[df['num_critics'] == optim]
    ...
    # Customize the plot
    plt.xlim(0, 1)
    if file == "ablation_multimodal.txt":
