...
X_FACTOR = 1e6
colour_list = {
    10.0: (129 / 255, 129 / 255, 129 / 255),
    1.0: (254 / 255, 6 / 255, 6 / 255),
    0.1: (168 / 255, 47 / 255, 47 / 255),
...
for file in environments:
    ...
    legend_handles = []
    optims = [optim for optim in df['a'].unique()]
    y_max, y_min = list(), list()
    for optim in optims:
        # Filter data for the current algorithm
        algo_data = df[df['a'] == optim]
